...
export default function Social() {
    return (
        <div id={socialStyles.mainSocial}>
            ...
            <a href="https://github.com/AliHaine" target="_blank"> <img className={socialStyles.img} src="/DiscordIcon.png" alt="GitHub Icon which redirect to https://github.com/AliHaine" /></a>
